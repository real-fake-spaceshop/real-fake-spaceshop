...
Travis continuous integration is configured for the official repo, as such all tests will be run on branch push and pull request. To run the test suite once on your local machine, run `npm t`.

For developing conveneince, you may run `npm run test-watch` to run the test suite in watch mode
